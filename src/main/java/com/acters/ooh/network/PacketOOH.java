...
/*
	...
	static void writeNBTTagCompound(NBTTagCompound tagCompound, DataOutput data) throws IOException
	{
		if (tagCompound == null)
		{
			data.writeShort(-1);
	...
	static NBTTagCompound readNBTTagCompound(DataInput data) throws IOException
	{
