...
public class OOHData
{
	...
	public NBTTagCompound writeToNBT (NBTTagCompound compound)
	{
		...
		compound.setTag("secondItem", secondItem == null ? new NBTTagCompound() : secondItem.writeToNBT(new NBTTagCompound()));
	...
	public OOHData readFromNBT (NBTTagCompound compound)
	{
		...
		{
			secondItem = new ItemStack(Items.cookie,0,0);
	...
	public static void setOOHData (Entity player, OOHData data)
	{
		...
		player.getEntityData().setTag("OOHData", data.writeToNBT(new NBTTagCompound()));
	}
